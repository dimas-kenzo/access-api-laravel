...
class PostController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $response = Http::withoutVerifying()->put('https://jsonplaceholder.typicode.com/posts/' . $id, [
    ...
    public function destroy($id)
    {
        ...
        $response = Http::withoutVerifying()->delete('https://jsonplaceholder.typicode.com/posts/' . $id);
